...
<section class="hidden md:inline fixed grid grid-rows-3 right-0 mr-6 bg-secondary gap-1 border border-t-0 divide-y divide-primary rounded-b-md" style="border-color: #A84958;">
    <button class="p-1 hover:text-secondary flex gap-1 items-center" onclick="toggleTheme()"><img class="w-[28px]" src="{{ asset('assets/frostyicons/theme.svg') }}"> Switch Theme</button>
    <a href="/aboutme" class="p-1 hover:text-secondary flex gap-1 items-center"><img class="w-[28px]" src="{{ asset('assets/frostyicons/person.svg') }}"> About Me</a>
    <a href="https://buymeacoffee.com/jaazim" target="_blank" class="p-1 hover:text-secondary flex gap-1 items-center"><img class="w-[28px]" src="{{ asset('assets/frostyicons/heart.svg') }}"> Support Me</a>
</section>
<!-- Main -->
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="overflow-y-auto max-h-[calc(100vh-200px)] md:overflow-visible">
            <table class="min-w-full table-auto border-collapse bg-blue-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100">
                ...
                @else
                    <tr>
                        <td colspan="4" class="text-center py-4 text-gray-400">No matching papers found.</td>
                    </tr>
                @endif
                </tbody>
            </table>
...
<section class="z-20 fixed right-0 top-[50%] hidden md:grid grid-cols-2 bg-secondary gap-1 border border-r-0 rounded-s-lg" dir="ltr" style="border-color: #A84958;">
    <div class="p-1 grid grid-rows-3 gap-2">
        <a href="#"><img id="whatsappicon" class="w-[28px]" src="{{ asset('assets/frostyicons/whatsapp.svg') }}"></a>
        <a href="#"><img id="facebookicon" class="w-[28px]" src="{{ asset('assets/frostyicons/facebook.svg') }}"></a>
        <a href="#"><img id="copylinkicon" class="w-[28px]" src="{{ asset('assets/frostyicons/copylink.svg') }}"></a>
    </div>
...
<footer class="inline md:hidden flex justify-center items-center bg-secondary gap-1 text-sm border-t bg-blue-900 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10">
    ...
    <a href="/aboutme" class="p-1 hover:text-secondary flex gap-1 items-center justify-center">
        <img class="w-[20px]" src="{{ asset('assets/frostyicons/person.svg') }}"> About Me
    </a>
    <a href="https://buymeacoffee.com/jaazim" target="_blank" class="p-1 hover:text-secondary flex gap-1 items-center justify-center">
        <img class="w-[20px]" src="{{ asset('assets/frostyicons/heart.svg') }}"> Support Me
    </a>
</footer>
</body>
</html>
